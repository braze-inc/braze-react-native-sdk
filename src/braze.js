...
export class Braze {
  ...
  static setTwitterData(
    ...
    if (
      ...
      console.log(
        'Invalid null argument(s) passed to Braze.setTwitterData(). Twitter data not set.'
      );
    }
  }
   ...
   */
  static setFacebookData(facebookUserDictionary, numberOfFriends, likes) {
    if (numberOfFriends !== null) {
      this.bridge.setFacebookData(
      ...
      console.log(
        'Invalid null argument(s) passed to Braze.setFacebookData(). Facebook data not set.'
      );
    }
  }
